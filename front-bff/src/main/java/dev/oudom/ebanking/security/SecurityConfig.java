package dev.oudom.ebanking.security;
...
public class SecurityConfig {
    ...
    @Bean
    public SecurityWebFilterChain webSecurity(ServerHttpSecurity http, ReactiveClientRegistrationRepository clientRegistrationRepository) {

        http.authorizeExchange(exchange -> exchange
                .pathMatchers("/test", "/profile/**", "/auth/**").authenticated()
